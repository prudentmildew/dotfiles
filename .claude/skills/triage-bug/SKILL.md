...
Create a GitHub issue using `gh issue create` with the template below. Label the issue `bug`. Do NOT ask the user to review before creating - just create it and share the URL.
